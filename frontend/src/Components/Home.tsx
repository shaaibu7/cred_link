      ...
      <div className="text-white flex justify-center align-middle flex-col items-center mt-7">
        ...
        <div className="mt-6">
          <button
            ...
            className="bg-[#3E8BFF] text-white rounded-[72px] text-xs p-4 font-normal w-40 h-13 text-center"
          >
            Get A Loan
          </button>
          <button
            onClick={handleLendClick}
            className="bg-[#3E8BFF] text-white rounded-[72px] text-xs p-4 font-normal w-40 h-13 text-center ml-3"
          >
            Lend
          </button>
        </div>
